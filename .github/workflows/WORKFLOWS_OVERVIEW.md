...
- Artifacts prefixed with `noetis-test-`
...
```
noetis-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `noetis-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `noetis-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `noetis-macos-aarch64-release-0.1.3`
...
- `NOETIS_RSA_PUBLIC_KEY` - License validation public key
