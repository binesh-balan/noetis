...
const HOMEBREW_PATHS = [
  '/opt/homebrew/var/noetis/meeting_minutes.db',  // Apple Silicon (M1/M2/M3)
  '/usr/local/var/noetis/meeting_minutes.db',      // Intel Macs
];
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-primary">
              Previous Noetis Installation Detected!
            </h3>
          </div>
          <p className="text-sm text-primary mb-2">
            We found an existing database from your previous Noetis installation (Python backend version).
          </p>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-success text-success-foreground rounded-lg hover:bg-success/90 disabled:bg-foreground disabled:cursor-not-allowed transition-colors"
            >
              {isImporting ? (
                <>
            ...
            <button
              onClick={handleNo}
              disabled={isImporting}
              className="flex-1 px-4 py-2 border-2 border-primary text-primary rounded-lg hover:bg-primary/10 disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
              No, Browse Manually
            </button>
          </div>
