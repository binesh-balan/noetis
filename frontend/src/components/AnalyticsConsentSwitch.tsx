...
export default function AnalyticsConsentSwitch() {
  ...
  const handlePrivacyPolicyClick = async () => {
    try {
      await invoke('open_external_url', { url: 'https://github.com/binesh-balan/noetis/blob/main/PRIVACY_POLICY.md' });
    } catch (error) {
  ...
  return (
    <>
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-2 p-2 bg-primary/10 rounded border border-primary">
