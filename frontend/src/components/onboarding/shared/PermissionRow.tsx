  ...
  return (
    <div
      className={cn(
        ...
        isAuthorized ? 'border-border bg-muted' : isDenied ? 'border-destructive bg-destructive/10' : 'bg-background border-border'
      )}
    >
      {/* Left side: Icon + Info */}
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div
          className={cn(
            ...
            isAuthorized ? 'bg-accent' : isDenied ? 'bg-destructive/10' : 'bg-muted'
          )}
        >
