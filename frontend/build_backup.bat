@echo off
REM Noetis Build Script for Windows
...
echo 🚀 Building Noetis application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Noetis Tauri application for Windows.
