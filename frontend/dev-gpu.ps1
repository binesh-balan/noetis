# GPU-accelerated development script for Noetis (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Noetis" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Noetis in development mode..." -ForegroundColor Blue
Write-Host ""
