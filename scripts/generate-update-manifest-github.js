...
console.log(`GitHub Repository: binesh-balan/noetis`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/binesh-balan/noetis/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/binesh-balan/noetis/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/binesh-balan/noetis/releases/latest/download/latest.json`);
