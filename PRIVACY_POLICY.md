...
Noetis is built on the principle that your meeting data should remain private and under your control. This privacy policy explains how we handle data in our open-source meeting assistant.
...
### What We Collect
Usage analytics is optional and off by default. When you choose to enable it, Noetis collects minimal, anonymized usage data:
...
For privacy-related questions or concerns, open an issue in this repository's [issue tracker](../../issues).
...
*This privacy policy applies to Noetis v0.0.5 and later versions. For enterprise deployments, additional privacy controls may be available.*
